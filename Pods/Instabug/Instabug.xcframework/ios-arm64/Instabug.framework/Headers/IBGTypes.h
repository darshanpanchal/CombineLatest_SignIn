/*
 File:       InstabugCoreInternal/IBGTypes.h
...
extern NSString * const kIBGInvalidCommentMessageStringName DEPRECATED_MSG_ATTRIBUTE("'kIBGInvalidCommentMessageStringName' is deprecated: first deprecated in SDK 11.4.0. Use kIBGInsufficientContentTitleStringName instead.");
extern NSString * const kIBGInvalidCommentTitleStringName DEPRECATED_MSG_ATTRIBUTE("'kIBGInvalidCommentTitleStringName' is deprecated: first deprecated in SDK 11.4.0. Use kIBGInsufficientContentMessageStringName instead.");
...
extern NSString * const kIBGFeatureRequetsPromptName DEPRECATED_ATTRIBUTE;
...
typedef NS_ENUM(NSInteger, IBGReportType) {
    IBGReportTypeBug = 1 << 0,
    IBGReportTypeFeedback = 1 << 1,
    IBGReportTypeQuestion = 1 << 2,
    IBGReportTypeOther = 1 << 3,
};
